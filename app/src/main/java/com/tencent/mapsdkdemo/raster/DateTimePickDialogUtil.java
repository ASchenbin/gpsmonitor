...
import android.widget.TimePicker.OnTimeChangedListener;
	 ...
	 * ����ʱ��ѡ��ؼ� 
	 * ʹ�÷�����
	   private EditText inputDate;//��Ҫ���õ�����ʱ���ı��༭��
	   private String initDateTime="2013��3��3�� 14:44",//��ʼ����ʱ��ֵ 
	       �ڵ���¼���ʹ�ã�
...
public class DateTimePickDialogUtil implements  OnDateChangedListener,OnTimeChangedListener{
		 ...
		 * @param initDateTime ��ʼ����ʱ��ֵ����Ϊ�������ڵı��������ʱ���ʼֵ
		 */
		...
		/**
		 * ʵ�ֽ���ʼ����ʱ��2013��03��02�� 16:45 ��ֳ��� �� �� ʱ �� ��,����ֵ��calendar
		 * @param initDateTime ��ʼ����ʱ��ֵ �ַ���
		 * @return Calendar
		 */
		private Calendar getCalendarByInintData(String initDateTime) {
			Calendar calendar = Calendar.getInstance();
			
			// ����ʼ����ʱ��2013��03��02�� 16:45 ��ֳ��� �� �� ʱ �� ��
